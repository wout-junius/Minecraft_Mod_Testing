...
public class KilledByCrossbowTrigger implements ICriterionTrigger<KilledByCrossbowTrigger.Instance> {
   ...
   public void trigger(ServerPlayerEntity p_215105_1_, Collection<Entity> p_215105_2_, int p_215105_3_) {
      ...
      if (killedbycrossbowtrigger$listeners != null) {
         killedbycrossbowtrigger$listeners.trigger(p_215105_1_, p_215105_2_, p_215105_3_);
      }
   ...
   static class Listeners {
      ...
      public void trigger(ServerPlayerEntity p_218008_1_, Collection<Entity> p_218008_2_, int p_218008_3_) {
         ...
         for(ICriterionTrigger.Listener<KilledByCrossbowTrigger.Instance> listener : this.field_218011_b) {
            if (listener.getCriterionInstance().test(p_218008_1_, p_218008_2_, p_218008_3_)) {
               if (list == null) {
