...
public class TridentRenderer extends EntityRenderer<TridentEntity> {
   ...
   protected void func_203085_b(TridentEntity tridentEntityIn, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      if (entity != null && tridentEntityIn.getNoClip()) {
         ...
         double d4 = MathHelper.lerp((double)partialTicks, entity.prevPosY + (double)entity.getEyeHeight() * 0.8D, entity.posY + (double)entity.getEyeHeight() * 0.8D);
         double d5 = MathHelper.lerp((double)partialTicks, entity.prevPosZ, entity.posZ);
         double d6 = d1 - d2;
         double d7 = d2 + d1;
         double d8 = MathHelper.lerp((double)partialTicks, tridentEntityIn.prevPosX, tridentEntityIn.posX);
         double d9 = MathHelper.lerp((double)partialTicks, tridentEntityIn.prevPosY, tridentEntityIn.posY);
         double d10 = MathHelper.lerp((double)partialTicks, tridentEntityIn.prevPosZ, tridentEntityIn.posZ);
