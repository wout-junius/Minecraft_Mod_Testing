...
public class BlockModelRenderer {
   ...
   public boolean renderModel(IEnviromentBlockReader worldIn, IBakedModel modelIn, BlockState state, BlockPos pos, BufferBuilder bufferBuilderIn, boolean p_217631_6_, Random rand, long p_217631_8_) {
      return renderModel(worldIn, modelIn, state, pos, bufferBuilderIn, p_217631_6_, rand, p_217631_8_, net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }

   public boolean renderModel(IEnviromentBlockReader worldIn, IBakedModel modelIn, BlockState state, BlockPos pos, BufferBuilder bufferBuilderIn, boolean p_217631_6_, Random rand, long p_217631_8_, net.minecraftforge.client.model.data.IModelData modelData) {
      boolean flag = Minecraft.isAmbientOcclusionEnabled() && state.getLightValue(worldIn, pos) == 0 && modelIn.isAmbientOcclusion();
      modelData = modelIn.getModelData(worldIn, pos, state, modelData);

      try {
         return flag ? this.renderModelSmooth(worldIn, modelIn, state, pos, bufferBuilderIn, p_217631_6_, rand, p_217631_8_, modelData) : this.renderModelFlat(worldIn, modelIn, state, pos, bufferBuilderIn, p_217631_6_, rand, p_217631_8_, modelData);
   ...
   @Deprecated //Forge: Model data argument
   public boolean renderModelSmooth(IEnviromentBlockReader p_217634_1_, IBakedModel p_217634_2_, BlockState p_217634_3_, BlockPos p_217634_4_, BufferBuilder p_217634_5_, boolean p_217634_6_, Random p_217634_7_, long seed) {
      return renderModelSmooth(p_217634_1_, p_217634_2_, p_217634_3_, p_217634_4_, p_217634_5_, p_217634_6_, p_217634_7_, seed, net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }

   public boolean renderModelSmooth(IEnviromentBlockReader p_217634_1_, IBakedModel p_217634_2_, BlockState p_217634_3_, BlockPos p_217634_4_, BufferBuilder p_217634_5_, boolean p_217634_6_, Random p_217634_7_, long seed, net.minecraftforge.client.model.data.IModelData modelData) {
      boolean flag = false;
   ...
   private void renderQuadsSmooth(IEnviromentBlockReader worldIn, BlockState state, BlockPos pos, BufferBuilder bufferBuilderIn, List<BakedQuad> quads, float[] weights, BitSet p_217630_7_, BlockModelRenderer.AmbientOcclusionFace p_217630_8_) {
      ...
      for(int j = quads.size(); i < j; ++i) {
         ...
         this.fillQuadBounds(worldIn, state, pos, bakedquad.getVertexData(), bakedquad.getFace(), weights, p_217630_7_);
         p_217630_8_.updateVertexBrightness(worldIn, state, pos, bakedquad.getFace(), weights, p_217630_7_);
         bufferBuilderIn.addVertexData(bakedquad.getVertexData());
         bufferBuilderIn.putBrightness4(p_217630_8_.vertexBrightness[0], p_217630_8_.vertexBrightness[1], p_217630_8_.vertexBrightness[2], p_217630_8_.vertexBrightness[3]);
         ...
         if (bakedquad.hasTintIndex()) {
            int k = this.blockColors.getColor(state, worldIn, pos, bakedquad.getTintIndex());
            float f = (float)(k >> 16 & 255) / 255.0F;
            float f1 = (float)(k >> 8 & 255) / 255.0F;
            float f2 = (float)(k & 255) / 255.0F;
            bufferBuilderIn.putColorMultiplier(p_217630_8_.vertexColorMultiplier[0] * f, p_217630_8_.vertexColorMultiplier[0] * f1, p_217630_8_.vertexColorMultiplier[0] * f2, 4);
            bufferBuilderIn.putColorMultiplier(p_217630_8_.vertexColorMultiplier[1] * f, p_217630_8_.vertexColorMultiplier[1] * f1, p_217630_8_.vertexColorMultiplier[1] * f2, 3);
            bufferBuilderIn.putColorMultiplier(p_217630_8_.vertexColorMultiplier[2] * f, p_217630_8_.vertexColorMultiplier[2] * f1, p_217630_8_.vertexColorMultiplier[2] * f2, 2);
            bufferBuilderIn.putColorMultiplier(p_217630_8_.vertexColorMultiplier[3] * f, p_217630_8_.vertexColorMultiplier[3] * f1, p_217630_8_.vertexColorMultiplier[3] * f2, 1);
         } else {
            bufferBuilderIn.putColorMultiplier(p_217630_8_.vertexColorMultiplier[0], p_217630_8_.vertexColorMultiplier[0], p_217630_8_.vertexColorMultiplier[0], 4);
            bufferBuilderIn.putColorMultiplier(p_217630_8_.vertexColorMultiplier[1], p_217630_8_.vertexColorMultiplier[1], p_217630_8_.vertexColorMultiplier[1], 3);
            bufferBuilderIn.putColorMultiplier(p_217630_8_.vertexColorMultiplier[2], p_217630_8_.vertexColorMultiplier[2], p_217630_8_.vertexColorMultiplier[2], 2);
            bufferBuilderIn.putColorMultiplier(p_217630_8_.vertexColorMultiplier[3], p_217630_8_.vertexColorMultiplier[3], p_217630_8_.vertexColorMultiplier[3], 1);
         }

         bufferBuilderIn.putPosition(d0, d1, d2);
      }
   ...
   static class Cache {
      ...
      public float func_222896_b(BlockState p_222896_1_, IEnviromentBlockReader p_222896_2_, BlockPos p_222896_3_) {
         ...
         float f1 = p_222896_1_.getAmbientOcclusionLightValue(p_222896_2_, p_222896_3_);
         if (this.field_222898_a) {
