...
public class WorldRenderer implements AutoCloseable, IResourceManagerReloadListener {
   ...
   public void renderEntities(ActiveRenderInfo p_215326_1_, ICamera p_215326_2_, float partialTicks) {
      if (this.renderEntitiesStartupCounter > 0) {
         ...
         if (!list1.isEmpty()) {
            for(Entity entity1 : list1) {
               this.renderManager.renderMultipass(entity1, partialTicks);
            }
         }
         ...
         if (this.isRenderEntityOutlines() && (!list.isEmpty() || this.entityOutlinesRendered)) {
            ...
            if (!list.isEmpty()) {
               ...
               for(int i = 0; i < list.size(); ++i) {
                  this.renderManager.renderEntityStatic(list.get(i), partialTicks, false);
               }
