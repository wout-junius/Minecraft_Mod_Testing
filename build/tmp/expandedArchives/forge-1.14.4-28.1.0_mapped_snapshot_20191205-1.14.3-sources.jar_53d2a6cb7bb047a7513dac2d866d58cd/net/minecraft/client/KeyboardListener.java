...
public class KeyboardListener {
   ...
   public String getClipboardString() {
      return this.clipboardHelper.getClipboardString(this.mc.mainWindow.getHandle(), (p_197966_1_, p_197966_2_) -> {
   ...
   public void setClipboardString(String string) {
      this.clipboardHelper.setClipboardString(this.mc.mainWindow.getHandle(), string);
   }
