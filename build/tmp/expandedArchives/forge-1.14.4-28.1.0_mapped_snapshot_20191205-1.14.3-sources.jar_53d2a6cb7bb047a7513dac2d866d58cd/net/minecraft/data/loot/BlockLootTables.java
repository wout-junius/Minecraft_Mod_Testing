...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   private static <T> T withExplosionDecay(IItemProvider p_218552_0_, ILootFunctionConsumer<T> p_218552_1_) {
   ...
   private static <T> T withSurvivesExplosion(IItemProvider p_218560_0_, ILootConditionConsumer<T> p_218560_1_) {
   ...
   private static LootTable.Builder dropping(IItemProvider p_218546_0_) {
   ...
   private static LootTable.Builder dropping(Block p_218494_0_, ILootCondition.IBuilder p_218494_1_, LootEntry.Builder<?> p_218494_2_) {
   ...
   private static LootTable.Builder droppingWithSilkTouch(Block p_218519_0_, LootEntry.Builder<?> p_218519_1_) {
      return dropping(p_218519_0_, SILK_TOUCH, p_218519_1_);
   }

   private static LootTable.Builder droppingWithShears(Block p_218511_0_, LootEntry.Builder<?> p_218511_1_) {
      return dropping(p_218511_0_, SHEARS, p_218511_1_);
   }

   private static LootTable.Builder droppingWithSilkTouchOrShears(Block p_218535_0_, LootEntry.Builder<?> p_218535_1_) {
      return dropping(p_218535_0_, SILK_TOUCH_OR_SHEARS, p_218535_1_);
   }

   private static LootTable.Builder droppingWithSilkTouch(Block p_218515_0_, IItemProvider p_218515_1_) {
      return droppingWithSilkTouch(p_218515_0_, withSurvivesExplosion(p_218515_0_, ItemLootEntry.builder(p_218515_1_)));
   }

   private static LootTable.Builder droppingRandomly(IItemProvider p_218463_0_, IRandomRange p_218463_1_) {
   ...
   private static LootTable.Builder droppingWithSilkTouchOrRandomly(Block p_218530_0_, IItemProvider p_218530_1_, IRandomRange p_218530_2_) {
   ...
   private static LootTable.Builder onlyWithSilkTouch(IItemProvider p_218561_0_) {
   ...
   private static LootTable.Builder droppingAndFlowerPot(IItemProvider p_218523_0_) {
   ...
   private static LootTable.Builder droppingSlab(Block p_218513_0_) {
   ...
   private static <T extends Comparable<T>> LootTable.Builder droppingWhen(Block p_218562_0_, IProperty<T> p_218562_1_, T p_218562_2_) {
   ...
   private static LootTable.Builder droppingWithName(Block p_218481_0_) {
   ...
   private static LootTable.Builder droppingWithContents(Block p_218544_0_) {
   ...
   private static LootTable.Builder droppingWithPatterns(Block p_218559_0_) {
   ...
   private static LootTable.Builder droppingItemWithFortune(Block p_218476_0_, Item p_218476_1_) {
    ...
    */
   private static LootTable.Builder droppingItemRarely(Block p_218491_0_, IItemProvider p_218491_1_) {
   ...
   private static LootTable.Builder droppingSeeds(Block p_218570_0_) {
    ...
    */
   private static LootTable.Builder droppingByAge(Block p_218475_0_, Item p_218475_1_) {
   ...
   private static LootTable.Builder onlyWithShears(IItemProvider p_218486_0_) {
    ...
    */
   private static LootTable.Builder droppingWithChancesAndSticks(Block p_218540_0_, Block p_218540_1_, float... p_218540_2_) {
    ...
    */
   private static LootTable.Builder droppingWithChancesSticksAndApples(Block p_218526_0_, Block p_218526_1_, float... p_218526_2_) {
    ...
    */
   private static LootTable.Builder droppingAndBonusWhen(Block p_218541_0_, Item p_218541_1_, Item p_218541_2_, ILootCondition.IBuilder p_218541_3_) {
   ...
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      ...
      this.registerLootTable(Blocks.BIRCH_LEAVES, (p_218518_0_) -> {
         return droppingWithChancesAndSticks(p_218518_0_, Blocks.BIRCH_SAPLING, DEFAULT_SAPLING_DROP_RATES);
      });
      this.registerLootTable(Blocks.ACACIA_LEAVES, (p_218477_0_) -> {
         return droppingWithChancesAndSticks(p_218477_0_, Blocks.ACACIA_SAPLING, DEFAULT_SAPLING_DROP_RATES);
      });
      this.registerLootTable(Blocks.JUNGLE_LEAVES, (p_218500_0_) -> {
         return droppingWithChancesAndSticks(p_218500_0_, Blocks.JUNGLE_SAPLING, RARE_SAPLING_DROP_RATES);
      });
      this.registerLootTable(Blocks.SPRUCE_LEAVES, (p_218506_0_) -> {
         return droppingWithChancesAndSticks(p_218506_0_, Blocks.SPRUCE_SAPLING, DEFAULT_SAPLING_DROP_RATES);
      });
      this.registerLootTable(Blocks.OAK_LEAVES, (p_218471_0_) -> {
         return droppingWithChancesSticksAndApples(p_218471_0_, Blocks.OAK_SAPLING, DEFAULT_SAPLING_DROP_RATES);
      });
      this.registerLootTable(Blocks.DARK_OAK_LEAVES, (p_218538_0_) -> {
         return droppingWithChancesSticksAndApples(p_218538_0_, Blocks.DARK_OAK_SAPLING, DEFAULT_SAPLING_DROP_RATES);
      });
