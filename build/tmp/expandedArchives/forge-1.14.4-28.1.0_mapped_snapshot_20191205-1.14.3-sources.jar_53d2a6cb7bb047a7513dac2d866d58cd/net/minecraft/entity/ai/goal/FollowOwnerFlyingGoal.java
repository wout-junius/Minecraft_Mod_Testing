...
public class FollowOwnerFlyingGoal extends FollowOwnerGoal {
   ...
   protected boolean canTeleportToBlock(BlockPos pos) {
      ...
      return (blockstate.isTopSolid(this.world, pos, this.tameable) || blockstate.isIn(BlockTags.LEAVES)) && this.world.isAirBlock(pos.up()) && this.world.isAirBlock(pos.up(2));
   }
}