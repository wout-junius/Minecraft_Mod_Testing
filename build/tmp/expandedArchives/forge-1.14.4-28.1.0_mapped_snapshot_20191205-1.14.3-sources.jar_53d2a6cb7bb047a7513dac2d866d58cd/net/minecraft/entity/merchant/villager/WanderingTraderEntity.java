      ...
      public void tick() {
         ...
         if (blockpos != null && WanderingTraderEntity.this.navigator.noPath()) {
            if (this.isWithinDistance(blockpos, 10.0D)) {
               Vec3d vec3d = (new Vec3d((double)blockpos.getX() - this.traderEntity.posX, (double)blockpos.getY() - this.traderEntity.posY, (double)blockpos.getZ() - this.traderEntity.posZ)).normalize();
               Vec3d vec3d1 = vec3d.scale(10.0D).add(this.traderEntity.posX, this.traderEntity.posY, this.traderEntity.posZ);
