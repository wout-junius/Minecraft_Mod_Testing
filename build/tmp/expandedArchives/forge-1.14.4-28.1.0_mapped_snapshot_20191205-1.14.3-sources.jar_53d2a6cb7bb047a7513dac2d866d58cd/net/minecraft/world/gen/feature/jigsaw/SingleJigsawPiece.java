...
public class SingleJigsawPiece extends JigsawPiece {
   ...
   public boolean place(TemplateManager templateManagerIn, IWorld worldIn, BlockPos pos, Rotation rotationIn, MutableBoundingBox boundsIn, Random rand) {
      ...
      if (!template.addBlocksToWorld(worldIn, pos, placementsettings, 18)) {
         ...
         for(Template.BlockInfo template$blockinfo : Template.processBlockInfos(worldIn, pos, placementsettings, this.func_214857_a(templateManagerIn, pos, rotationIn, false))) {
