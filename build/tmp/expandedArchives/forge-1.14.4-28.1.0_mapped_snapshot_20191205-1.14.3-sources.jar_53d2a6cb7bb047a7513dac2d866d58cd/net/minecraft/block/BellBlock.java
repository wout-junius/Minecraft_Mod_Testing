...
public class BellBlock extends ContainerBlock {
   ...
   public boolean ring(World worldIn, BlockState state, @Nullable TileEntity p_220130_3_, BlockRayTraceResult p_220130_4_, @Nullable PlayerEntity ringingPlayer, boolean checkDirection) {
      Direction direction = p_220130_4_.getFace();
      BlockPos blockpos = p_220130_4_.getPos();
      boolean flag = !checkDirection || this.canRingFrom(state, direction, p_220130_4_.getHitVec().y - (double)blockpos.getY());
      if (!worldIn.isRemote && p_220130_3_ instanceof BellTileEntity && flag) {
         ((BellTileEntity)p_220130_3_).ring(direction);
